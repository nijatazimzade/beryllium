; (function () {
    ...
    'use strict';
    let skip = 6;
    let postCount = $("#postCount").val();

    $(document).on("click", "#load-more-btn", function (e) {
        console.log("salam")
        e.preventDefault();
        $.ajax({
            url: "/News/LoadPostsAsView?skip=" + skip,
            type: "get",
    ...
    $(document).on("keyup", "#work-searcher", function () {
        $("#search-results").html("");
        let query = $("#work-searcher").val();
        $.ajax({
            url: "/Works/SearchWorks?query=" + query,
            type: "get",
